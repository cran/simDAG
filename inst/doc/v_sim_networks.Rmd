...
The following vignette introduces this methodology and how it is implemented in the `simDAG` R package [@Denz2026]. This is an advanced topic. We assume that the reader is already familiar with the general `simDAG` syntax and DAG based simulations. Please consult the associated paper or the numerous other vignettes first, if this is not the case.
