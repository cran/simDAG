...
| `node_polr()` | A node based on ordered logistic or probit regression (categorical data) |
...
| `node_aalen()` | A node based on an Aalen additive hazards model (time-to-event data) |
