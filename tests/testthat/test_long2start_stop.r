...
test_that("event right at the start", {
...
test_that("event of length 1 right at the start", {

  long <- data.table(.id=c(1, 1, 1, 2, 2, 2, 3, 3, 3, 4, 4, 4),
  ...
  expected <- data.table(.id=c(1, 1, 2, 3, 4, 4),
                         start=c(1, 2, 1, 1, 1, 2),
                         stop=c(1, 3, 3, 3, 1, 3),
                         A=c(TRUE, FALSE, FALSE, TRUE, FALSE, TRUE),
                         B=FALSE)
